...
AI-powered livestock grading and management platform. Camera-based body measurement using computer vision for goats and lambs - three angles, automated YOLO segmentation, calibrated pixel-to-centimeter conversion, and a grade with documented reasoning. Built for [Clean Chickens and Co.](https://www.cleanchickens.com), a livestock facility in Elk River, Minnesota.
