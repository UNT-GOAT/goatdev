...
for service in goat-prod.service goat-training.service goat-display.service camera-heating.service view-focus.service setup-proxy.service git-sync-on-boot.service; do
